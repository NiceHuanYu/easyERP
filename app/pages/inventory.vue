  ...
  <div class="page">
    ...
    <div class="tab-content">
      ...
      <div class="tab-placeholder">
        ...
        <p class="placeholder-hint">后续将在此处实现库存的收发存管理与流水追溯</p>
      </div>
    </div>
  </div>
</template>
...
const tabs = [
  { key: 'overview', icon: '📊', label: '库存概览',   description: '查看各仓库的实时库存余额与可用量' },
  { key: 'inbound',  icon: '📥', label: '入库管理',   description: '采购入库、生产完工入库、退货入库等' },
  { key: 'outbound', icon: '📤', label: '出库管理',   description: '销售出库、生产领料、调拨出库等' },
  { key: 'transfer', icon: '🔄', label: '库存调拨',   description: '仓库间或库位间的物料调拨管理' },
  { key: 'count',    icon: '🔢', label: '库存盘点',   description: '创建盘点计划、录入实盘数量、处理差异' },
  { key: 'journal',  icon: '📜', label: '库存流水',   description: '按时间顺序查看所有库存变动明细' },
]
