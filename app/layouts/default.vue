...
const navItems = [
  ...
  { path: '/purchase', icon: '🛒', label: '采购管理', disabled: false },
  { path: '/production', icon: '🏭', label: '生产管理', disabled: false },
  { path: '/inventory', icon: '📋', label: '库存管理', disabled: false },
  { path: '/quality', icon: '✅', label: '品质管理', disabled: false },
  { path: '/finance', icon: '💰', label: '财务管理', disabled: false },
  { path: '/organization', icon: '👥', label: '组织管理', disabled: false },
  { path: '/analytics', icon: '📈', label: '数据分析', disabled: false },
