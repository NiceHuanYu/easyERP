...
<div class="erp-form-group"><label>入库类型</label><select v-model="f.type"><option v-for="t in types" :key="t" :value="t">{{ t }}</option></select></div>
...
<div class="erp-form-group"><label>仓库</label><input v-model="f.wh" placeholder="如 原材料库"/></div>
<div class="erp-form-group"><label>来源单号</label><input v-model="f.src" placeholder="关联单号"/></div>
<div class="erp-form-group"><label>日期</label><input v-model="f.date" type="text" placeholder="2025-08-01"/></div>
<div class="erp-form-group"><label>状态</label><select v-model="f.status"><option>草稿</option><option>已入库</option></select></div>
