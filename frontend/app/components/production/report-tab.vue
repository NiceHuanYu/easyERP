...
<style scoped>
.erp-tag.draft{background:#f5f5f5;color:#999;}.erp-tag.pending-review{background:#fff3e0;color:#e65100;}.erp-tag.confirmed{background:#fff3e0;color:#e65100;}.erp-tag.approved{background:#e8f5e9;color:#2e7d32;}
</style>
